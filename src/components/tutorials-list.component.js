...
export default class TutorialsList extends Component {
    ...
    render() {
        const {tutorials,currentTutorial,currentIndex, filterText}  = this.state
        return(
            <div className="list row">
                ...
                <ul className="list-group">
                    {tutorials && tutorials.filter((tutorial) =>
                                tutorial.title.toLowerCase().includes(filterText.toLowerCase())
                            ).map((tutorial,index)=>( //tutorials array içindeki her bir elemanı tutorial nesnesi olarak kullandık
